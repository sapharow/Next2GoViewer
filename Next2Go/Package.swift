...
let package = Package(
    ...
    dependencies: [
        // I'm usually not taking much dependencies onboard.
    ...
    targets: [
        .target(name: "Model"),
        .target(name: "ViewModel", dependencies: ["Model"]),
        .target(name: "Services", dependencies: ["Model"]),
        .target(name: "Next2GoUI", dependencies: ["ViewModel", .product(name: "Factory", package: "Factory")]),
        .testTarget(name: "ModelTests", dependencies: ["Model"]),
        .testTarget(name: "ViewModelTests", dependencies: ["ViewModel"]),
